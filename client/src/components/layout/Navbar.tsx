        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16 gap-2 sm:gap-3">
            ...
            <button onClick={() => setSearchOpen(true)}
              className="flex-1 max-w-lg mx-auto hidden md:flex items-center gap-3 px-4 py-2 rounded-xl border text-left transition-all hover:border-brand-primary/50 group"
